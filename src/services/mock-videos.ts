import {TkVideo} from './content';

export const MOCK_LANDSCAPE_VIDEOS: TkVideo[] = [
  {
    id: '1',
    type: 'video',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://i.ytimcg.com/vi/Dr9C2oswZfA/maxresdefault.jpg',
    duration: '8:18',
    uploadTime: 'May 9, 2011',
    views: '24,969,123',
...
export const MOCK_PORTRAIT_VIDEOS: TkVideo[] = [
  {
    id: '1',
    type: 'video',
    title: 'Selfie Makeup Transformation',
    thumbnailUrl: 'https://i.ytimg.com/vi_webp/sTByTbavlmk/maxresdefault.webp',
    duration: '7:30',
    uploadTime: 'Apr 8, 2023',
    views: '10',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://i.ytimg.com/vi_webp/fCjOGWdD6q0/maxresdefault.webp',
    duration: '5:45',
    uploadTime: 'Apr 7, 2023',
    views: '50',
